...
<section class="promotion">
        ...
        <div class="promotion__row row">
            ...
            <div class="promotion__wrapper">
                <article class="menu__item">
                    ...
                    <h3 class="subtitle">Подарок к первому заказу</h3>
                    <p class="text">К 1-му заказу от 1490 ₽ дарим пиццу бесплатно!</p>
                </article>
    ...
    <div class="promotion__leaf-left decs">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/image/promo-leaf-left.png' ); ?>" alt="">
    </div>

    <div class="promotion__leaf-right decs">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/image/promo-leaf-right.png' ); ?>" alt="">
    </div>
</section>
